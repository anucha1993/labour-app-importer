...
@section('content')
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-2">
                    ...
                    <select name="labour_prefix" class="form-select" required disabled>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="labour_fullname" placeholder="Fullname" class="form-control" value="{{$labour->labour_fullname}}" disabled>
                </div>
                <div class="col-md-3">
                    <label for="">เพศ</label>
                    <select name="labour_sex" class="form-control form-select" id="sex" disabled  placeholder="Fullname">
                         @php
            ...
            <div class="row">
                <div class="col-md-6 pt-3">
                    ...
                    <select name="labour_agency" id="agency" class="form-control" disabled>
                ...
                <div class="col-md-3 pt-3">
                    ...
                    <input type="date" name="labour_birthday"  onchange="calAge(this)" id="birthday" class="form-control" value="{{$labour->labour_birthday}}" disabled>
                </div>
                <div class="col pt-3">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <input type="text" name="labour_passport_number" placeholder="PassportNumber" class="form-control" value="{{$labour->labour_passport_number}}" disabled> 
                </div>
                <div class="col">
                    <label for="">วันที่ออกเล่ม</label>
                    <input type="date" name="labour_passport_date_start" placeholder="PassportNumber" class="form-control" value="{{$labour->labour_passport_date_start}}" disabled>
                </div>
                <div class="col">
                    <label for="">วันที่หมดอายุ</label>
                    <input type="date" name="labour_passport_date_end" onchange="passend(this)" id="pass-date-end"value="{{$labour->labour_passport_date_end}}" class="form-control" disabled>
                    <p><label id="out1"></label></p>
                </div>
                <div class="col">
                    <label for="">จำนวนวันที่เหลือ ก่อนหมดอายุ</label>
                    <input type="text" id="PassEndDate" placeholder="PassportDateEnd" class="form-control" disabled>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <input type="text" name="labour_visa_number" placeholder="PassportNumber" class="form-control" value="{{$labour->labour_visa_number}}" disabled>
                </div>
                <div class="col">
                    <label for="">วันที่เดินทางเข้ามา</label>
                    <input type="date" name="labour_visa_date_in"  class="form-control" value="{{$labour->labour_visa_date_in}}" disabled>
                </div>
                <div class="col">
                    <label for="">วันที่เริ่มวิซ่า</label>
                    <input type="date" name="labour_visa_date_start" class="form-control" value="{{$labour->labour_visa_date_start}}" disabled>
                </div>
                <div class="col">
                    <label for="">วันที่หมดอายุ</label>
                    <input type="date" name="labour_visa_date_end" onchange="visaend(this)" disabled id="visa-date-end" placeholder="Visa" class="form-control" value="{{$labour->labour_visa_date_end}}">
                    <p><label id="out1"></label></p>
                </div>
                <div class="col">
                    <label for="">จำนวนวันที่เหลือ ก่อนหมดอายุ</label>
                    <input type="text" id="VisaEndDate" placeholder="VisaDateEnd" class="form-control" disabled>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <input type="text" name="labour_workpremit_number" placeholder="WorkPremitNumber" class="form-control" value="{{$labour->labour_workpremit_number}}" disabled>
                </div>
                <div class="col">
                    <label for="">รหัสพนักงาน (ถ้ามี)</label>
                    <input type="text" name="labour_labour_number"  class="form-control" value="{{$labour->labour_labour_number}}" disabled>
                </div>
                <div class="col">
                    <label for="">วันที่ใบอนุญาตเริ่มต้น</label>
                    <input type="date" name="labour_workpremit_date_start" class="form-control" value="{{$labour->labour_workpremit_date_start}}" disabled>
                </div>
                <div class="col">
                    <label for="">วันที่ใบอนุญาตสิ้นสุด</label>
                    <input type="date" name="labour_workpremit_date_end" onchange="Workpremitend(this)" id="workpremit-date-end" disabled placeholder="WorkPreMit" class="form-control" value="{{$labour->labour_workpremit_date_end}}">
                    <p><label id="out1"></label></p>
                </div>
                <div class="col">
                    <label for="">จำนวนวันที่เหลือ ก่อนหมดอายุ</label>
                    <input type="text" id="workpremitEndDate" placeholder="workpremitDateEnd" class="form-control" disabled>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <input type="date" name="labour_day90_date_start" class="form-control" value="{{$labour->labour_day90_date_start}}" disabled>
                </div>
                <div class="col-md-3">
                    <label for="">วันที่รายงานตัว 90 วัน สิ้นสุด</label>
                    <input type="date" name="labour_day90_date_end" id="day90-date-end" onchange="day90end(this)" disabled class="form-control" value="{{$labour->labour_day90_date_end}}">
                </div>
                <div class="col-md-3">
                    <label for="">จำนวนวันที่เหลือ ก่อนหมดอายุ</label>
                    <input type="text" id="day90End" class="form-control" placeholder="Day90DateEnd" disabled>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <input type="text" name="labour_tm_number" class="form-control" placeholder="เลขที่ ตม." value="{{$labour->labour_tm_number}}" disabled>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <input type="date" name="labour_jobdate_start" class="form-control" value="{{$labour->labour_jobdate_start}}" disabled>
                </div>
                <div class="col-md-3">
                    <label for="">สถานะแรงงาน</label>
                    <select name="labour_status_job" id="labour_status" onchange="selectstatus(this)" class="form-control form-select" disabled>
                         @php
            ...
            <div class="row">
                <div class="col-md-3">
                    <input type="radio" name="labour_status" value="enable"  disabled
                    @if ($labour->labour_status == 'enable')
                     checked
                    @endif>
                    <label for="">เปิดใช้งาน</label>
                    <input type="radio" name="labour_status" value="disable"disabled
                    @if ($labour->labour_status == 'disable') 
                    checked
                   @endif>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <textarea name="labour_note" class="form-control" cols="15" rows="10" disabled>{{$labour->labour_note}}</textarea>
                </div>
            </div>

            <div class="border-top">
                <div class="card-body">
                    <a href="{{route('labour.index')}}" class="btn btn-primary ">ปิด</a>
                </div>
            </div>
    ...
    // $(document).change('keyup','#labour_status',function() {
    //     var select = $(this).val();
    //     console.log(select);
    //     $.ajax({
    ...
    if(select == 'resign'){
           document.getElementById("status_labour").innerHTML = '<label for="">วันที่ลาออก</label> <input type="date" class="form-control" name="labour_resing_date"  value="{{$labour->labour_resing_date}}" disabled>';
    }
    if(select == 'escape'){
           document.getElementById("status_labour").innerHTML = '<label for="">วันที่หลบหนี</label> <input type="date" class="form-control" name="labour_escape_date" value="{{$labour->labour_escape_date}}" disabled>';
    }
}
selectstatus();
